...
- 任务入口：`docs/task-packages/README.md` + `docs/task-packages/v2/INDEX.md`；移动端下一步应单独开包做 App 内 server/token 配置 UX、Keychain 保存、连接状态提示或提交整理。
- 执行规则：所有开发任务必须 TDD。
