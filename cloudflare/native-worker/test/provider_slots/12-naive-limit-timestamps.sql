-- Issue #61 跨实现 fixture：额度记录的 reset_at / observed_at 都没有时区标记。
-- 判不了年龄和是否已 reset，两侧必须给出同一个 fail closed 结论。
-- （Python 把无时区当系统本地时区，workerd 的 new Date() 当 UTC，
--   不显式 fail closed 的话宿主时区一变结论就分叉。）
...
INSERT INTO limit_windows (
  ...
  ('claude-main', 'claude', 'week', 78.25, 21.75, '2026-06-10T00:00:00', 10080, 'oauth_usage_api', 'observed', 'ok', '2026-06-03T11:00:00', '2026-06-03T11:00:00', '2026-06-03T11:00:00');
