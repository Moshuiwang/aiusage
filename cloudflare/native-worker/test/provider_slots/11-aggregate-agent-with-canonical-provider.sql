-- Issue #61 跨实现 fixture：agent 写成 'all'（pusher 只有聚合行时的真实写法），
-- 但 canonical 的 ai_provider 是 claude。用量必须落进 Claude 槽位，
-- 不能因为 agent 名字不含 "claude" 就读成「Claude 没有用量」。
...
INSERT INTO usage_hourly_facts (
  ...
  ('fact-aggregate-20260603-09', 'mac-local', 'macbook-pro', 'alice', 'claude', 'claude-main', 'all', 'cli', '2026-06-03T09:00:00+08:00', '2026-06-03T10:00:00+08:00', 'Asia/Shanghai', 2200, 600, 200, 100, 0, 3100, 1.23, 4, 2, 'observed', 'seed', '{"seed":"aggregate-today"}', '2026-06-03T09:00:00+08:00', '2026-06-03T11:30:00+08:00');
