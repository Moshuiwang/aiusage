-- Issue #61 跨实现 fixture：第三方 provider（antigravity）有 canonical ai_provider，
-- 但固定槽位只有 claude / codex 两个，它的用量进不了任何槽位。
...
INSERT INTO ai_accounts (provider, account_id, account_label, display_name, subscription, first_seen_at, last_seen_at) VALUES
  ...
  ('antigravity', 'ag-main', 'Antigravity Lab', 'Antigravity Lab', 'team', '2026-06-03T10:00:00+08:00', '2026-06-03T11:31:00+08:00');
...
INSERT INTO usage_hourly_facts (
  ...
  ('fact-antigravity-20260603-10', 'workstation-cara', 'workstation-9', 'cara', 'antigravity', 'ag-main', 'antigravity', 'desktop', '2026-06-03T10:00:00+08:00', '2026-06-03T11:00:00+08:00', 'Asia/Shanghai', 700, 300, 50, 50, 0, 1100, 0.44, 2, 1, 'inferred', 'seed', '{"seed":"antigravity-today"}', '2026-06-03T10:00:00+08:00', '2026-06-03T11:31:00+08:00');
