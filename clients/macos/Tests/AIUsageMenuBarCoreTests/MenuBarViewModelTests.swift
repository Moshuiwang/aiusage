...
final class MenuBarViewModelTests: XCTestCase {
    func testBuildsCompactStatusAndPopoverSections() throws {
        ...
        XCTAssertEqual(state.statusTitle, "AI 5.0K")
        ...
        XCTAssertEqual(state.lastUpdatedText, "10:45 · Asia/Shanghai")
        XCTAssertEqual(state.sources.map(\.title), ["linux-dev · wang", "macbook-pro · wang"])
        XCTAssertEqual(state.sources.first?.subtitle, "10:40 更新 · linux")
